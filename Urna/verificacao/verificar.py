...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		#self.lblTitulo.setStyleSheet("border: 2px solid");
		...
		self.lblVoto.setGeometry(QRect(50, self.lblTitulo.pos().y() + self.lblTitulo.height() + 50, self.screenWidth - 100, self.screenHeight - 150 - self.lblTitulo.height()))
		#self.lblVoto.setStyleSheet("border: 2px solid");
